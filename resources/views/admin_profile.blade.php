...
<body>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="{{asset($photo)}}" alt="Profile" class="rounded-circle">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="{{route('createAdmin')}}">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="{{route('adminLogin')}}">
            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <div class="row mb-3" >
                      ...
                      <div class="col-md-8 col-lg-9">
                        <img id="uploading_image" style="border-radius: 50%;" src="{{asset($photo)}}" alt="Profile">
                        <div class="col-md-7 mt-1">
                            <input type="file" id="profile_photo" class="form-control" name="profile_photo" accept="image/*" required>
                        </div>
                        <!-- <div class="pt-2">
                          <a href="#" class="btn btn-primary btn-sm" title="Upload new profile image"><i class="bi bi-upload">   Change Profile Image</i></a>
                ...
                <div class="tab-pane fade pt-3" id="profile-change-password">
                  ...
                  <form action="{{route('adminChangePwd')}}" method="POST">
                  @csrf
                    <div class="row mb-3">
  ...
  <script>
      $('#profile_photo').on("change", function() {
        ...
        $("#uploading_image").removeAttr("src");
        
        // var path =  URL.createObjectURL($("#profile_photo")[0].value);
        $("#uploading_image").prop("src",URL.createObjectURL($('#profile_photo')[0].files[0]));
      });
      // console.log()
